angular.module('JohnMarksPortfolio', ['ngRoute'])
...
.controller('WorkCtrl', ['$scope', function($scope) {
    ...
    $scope.fewdProjects = [
        ...
        { id: "pamsdoterra",
            ...
            title: "Pam's doTerra Invitations",
            orientation: "wide",
    ...
    $scope.hpProjects = [
        { id: "rgs",
            ...
            title: "HP Remote Graphics Software",
            orientation: "wide",
        ...
        { id: "graphicsdevice",
            href: "",
            title: "HPUX Graphics Device Drivers",
            orientation: "wide",
    ...
    $scope.seismicProjects = [
        { id: "seismicprocessing",
            ...
            title: "Seismic Data Processing @ Amerada Hess",
            orientation: "tall",
        ...
        { id: "seismicacquisition",
            href: "",
            title: "Seismic Data Acquisition @ Seismograph Serivce Corporation",
            orientation: "wide",
            indata:  {xoff: 0, yoff: 0, zoom:150},
            outdata: {xoff: 0, yoff: 0, zoom:100}
        }
   ...
   return {
       ...
       link: function(scope, element, attrs) {
           ...
           scope.hoverin = function(project) {
               ...
               doHover(project.indata.xoff, project.indata.yoff, project.indata.zoom, project.orientation, 1.5, 1.0, true);
           };
           scope.hoverout = function(project) {
               if (project.title === "") return;
               doHover(project.outdata.xoff, project.outdata.yoff, project.outdata.zoom, 1.0, 0.7, false);
           };
